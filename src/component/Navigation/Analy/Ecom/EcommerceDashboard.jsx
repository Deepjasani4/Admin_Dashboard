    ...
    <div className="ecom-dashboard-container">
      ...
      <div className="ecom-header-nav">
        ...
        <div className="breadcrumbs">
          Home / Dashboard / <span className="active">eCommerce</span>
        </div>
      </div>
      ...
      <div className="metrics-row-grid">
        ...
        <div className="progress-metric-card">
          ...
          <div className="metric-ratio">
            <span className="bold-num">237</span>{" "}
            <span className="muted-max">/ 400</span>
          </div>
        ...
        <div className="progress-metric-card">
          ...
          <div className="metric-ratio">
            <span className="bold-num">100</span>{" "}
            <span className="muted-max">/ 500</span>
          </div>
          <div className="progress-bar-track">
            <div
        ...
        <div className="progress-metric-card">
          ...
          <div className="metric-ratio">
            <span className="bold-num">50</span>{" "}
            <span className="muted-max">/ 400</span>
          </div>
          <div className="progress-bar-track">
            <div
      ...
      <div
        className="widgets-row-grid split-chart-layout"
      >
          ...
          <div className="summary-card-header">
            <div className="header-left-meta">
              ...
              <div className="financial-legend-metrics">
                <span>
                  Invoiced <strong className="txt-dark">$2,356.4</strong>
                </span>
                <span>
                  Profit <strong className="txt-dark">$1,935.6</strong>
                </span>
                <span>
                  Expenses <strong className="txt-dark">$468.9</strong>
                </span>
              </div>
            </div>
          ...
          <div className="main-bar-chart-wrapper">
            ...
            <div className="chart-inline-legend">
              <span className="legend-dot">
                <span className="dot-color blue-dot"></span> Invoiced
              </span>
              <span className="legend-dot">
                <span className="dot-color teal-dot"></span> Profit
              </span>
            </div>
          </div>
        </div>
