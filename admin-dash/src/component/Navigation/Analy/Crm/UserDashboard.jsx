...
import { Phone, Search, PlusCircle, SlidersHorizontal, Check, X } from 'lucide-react';
import Chart from 'react-apexcharts'; // Importing ApexCharts
import './UserDashboard.css';

// Initialized Mock User Roster
const initialUsers = [
  { id: 1, name: 'Alex Smith', email: 'alex.smith@example.com', status: 'Approved', avatarBg: '#db2777', initials: 'AS' },
  { id: 2, name: 'John Doe', email: 'john.doe@example.com', status: 'Pending', avatarBg: '#059669', initials: 'JD' },
  { id: 3, name: 'Sarah Wilson', email: 'sarah.wilson@example.com', status: 'Approved', avatarBg: '#ea580c', initials: 'SW' },
  { id: 4, name: 'Mike Johnson', email: 'mike.j@example.com', status: 'Pending', avatarBg: '#2563eb', initials: 'MJ' },
  { id: 5, name: 'Emma Lewis', email: 'emma.lewis@example.com', status: 'Pending', avatarBg: '#7c3aed', initials: 'EL' },
];
        ...
        <div className="dash-card">
          ...
          <div className="table-responsive">
            <table className="custom-table">
              <thead>
                <tr>
                  <th>User <span className="sort-icon-span">▲▼</span></th>
                  <th>Email <span className="sort-icon-span">▲▼</span></th>
                  <th>Status <span className="sort-icon-span">▲▼</span></th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={user.id}>
                    ...
                    <td>
                      <div className="actions-cell-flex">
                        <button className="btn-action-approve" onClick={() => handleApprove(user.id)}>
                          <Check size={12} /> Approve
                        </button>
                        <button className="btn-action-reject" onClick={() => handleReject(user.id)}>
                          <X size={12} /> Reject
                        </button>
                      </div>
                    </td>
